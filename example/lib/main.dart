...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    var player = BackgroundAudio.song == null
        ? Container()
        : Container(
            height: 240.0,
            child: SingleChildScrollView(
              child: Column(children: [
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  BackgroundAudio.song == null
                      ? Container()
                      : Flexible(
                          child: Column(children: <Widget>[
                            Text(BackgroundAudio.song["title"],
                                style: TextStyle(fontSize: 16.0)),
                            Text(BackgroundAudio.song["author"]),
                            SizedBox(height: 12.0),
                            Text(
                              (BackgroundAudio.playlist.metadata["title"] ??
                                  ""),
                              style:
                ...
                Text(BackgroundAudio.position.toString() +
                    '/' +
                    BackgroundAudio.duration.toString()),
                Slider(
                  onChanged: (val) {
